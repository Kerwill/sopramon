...
public class ProgrammeGenerator {
	...
	public static Sopramon addSopramon() throws ParseException {
		...
		mySopramon.setSigne(SigneGenerator
	...
	public static void addBoss() throws ParseException {
		...
		myBoss.setSigne(SigneGenerator.getAstrologicalSign(formatter.parse(jourNaissance + "/" + moisNaissance + "/" + anneeNaissance)));
